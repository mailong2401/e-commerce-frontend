...
export default function HeroSection() {
  return (
    <div className="relative flex flex-col w-2/3 bg-gradient-to-br from-black to-gray-900 h-screen justify-center overflow-hidden">
      ...
      <div className='absolute flex top-10 left-10 gap-3 items-center z-10'>
        ...
        <div>
          <h1 className='text-white font-bold text-2xl tracking-tight'>LongTri Official</h1>
          <p className='text-white/70 text-xs'>Mua sắm cao cấp</p>
        </div>
      </div>
      ...
      <div className='gap-8 flex flex-col justify-center px-16 z-10'>
        ...
        <div className='flex gap-6 pt-4'>
          <div className='flex items-center gap-2'>
            ...
            <span className='text-white/80 text-sm'>Giao hàng toàn quốc</span>
          </div>
          <div className='flex items-center gap-2'>
            <div className='w-2 h-2 bg-green-400 rounded-full'></div>
            <span className='text-white/80 text-sm'>Đổi trả 15 ngày</span>
          </div>
          <div className='flex items-center gap-2'>
            <div className='w-2 h-2 bg-green-400 rounded-full'></div>
            <span className='text-white/80 text-sm'>Hỗ trợ 24/7</span>
          </div>
        </div>
      </div>
